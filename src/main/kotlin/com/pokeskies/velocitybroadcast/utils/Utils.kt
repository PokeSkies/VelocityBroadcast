...
object Utils {
    ...
    fun printDebug(message: String, bypassCheck: Boolean = false) {
        if (bypassCheck || ConfigManager.CONFIG.debug)
            VelocityBroadcast.LOGGER.info("[${VelocityBroadcast.MOD_NAME}] DEBUG: $message")
    }

    fun printError(message: String) {
        VelocityBroadcast.LOGGER.error("[${VelocityBroadcast.MOD_NAME}] ERROR: $message")
    }

    fun printInfo(message: String) {
        VelocityBroadcast.LOGGER.info("[${VelocityBroadcast.MOD_NAME}] $message")
    }
